...
andrea = Admin.create(username: "andrea", email:'andrea@portfolio.com', password_digest:"andrea123portfolio")
...
DesignProject.create(name: "We All Bleed", 
                      ...
                      e_url: "<iframe width="560" height="315" src="https://www.youtube.com/embed/lmDHVKdAUXo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>",
...
DesignProject.create(name: "Amateur Hour is Over", 
                      ...
                      e_url: null,
                      detail:"The challenge consisted of a single poster for the 2019 KIA Stinger with the tagline "fuel by youth."
                      Amateur hour is over concept was born on KIA's belief in a young automobile brand that does not sacrifice price over quality and looks.
                      The KIA Stinger represents the new adult. The one that does not settle for the conventional. He keeps on living and exploring, not losing himself in the status quo. KIA Stinger is for a new generation of professionals.",
                      category: "Advrtising",
                      admin: andrea) 
